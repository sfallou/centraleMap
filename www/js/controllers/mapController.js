angular.module('centralemap').controller('MapController',
  [ '$scope',
    ...
    function(
      ...
      /** logo AEECL**/
      $scope.navTitle='<img class="titreLogo" src="img/logoAEECL.png" /><span class="titre">Central\'Map</span>';
      /**
      ...
      $scope.$on("$stateChangeSuccess", function() {
        ...
        $scope.legend = {
          position: 'bottomleft',
          colors: [ 'white','white','blue', 'red', 'orange', '#5EB6DD', 'green' ],
          labels: [ 'Tapez sur un bâtiment','----------------------------','Résidence', 'Vie Etudiante', 'Administration', 'Cours', 'Labo' ]
        };
      ...
      $scope.goTo = function(locationKey) {
        ...
        leafletData.getMap().then(function(map) {
                    if (map.getCenter().lat==LocationsService.savedLocations[0].lat && map.getCenter().lng==LocationsService.savedLocations[0].lng){
